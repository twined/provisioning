...
# Extra stuff
apk add shadow@edge util-linux fail2ban bash htop wget curl git sudo nano supervisor zsh openssl py2-pip
...
cp ${config_dir}/iptables/v4_basic /etc/iptables/rules-save
